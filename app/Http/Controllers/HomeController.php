    ...
    public function index(Request $request)
    {
       ...
       $home1_blogs = Blog::with('category', 'bloglanguagefrontend')->where(['status' => 1, 'show_homepage' => 1])->orderBy('id','desc')->get()->take($home1_blog_control->qty);
        ...
        $counter_section = (object) array(
            ...
            'counter1_value'  => $total_items,
            'counter2_value'  => $total_sales,
            'counter3_value'  => $total_clients,
            'counter4_value'  => number_format($average_rating, 1), // যেমন 4.5

            'counter1_title'  => 'Total Items',
            'counter2_title'  => 'Total Items Sales',
            'counter3_title'  => 'Total Clients',
            'counter4_title'  => 'Average Ratings',
