                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">{{__('admin.Commission Type')}}</label>
                                                            <select name="commission_type" id="" class="form-control">
                                                                <option {{ $setting->commission_type  == 'commission' ? 'selected' : '' }} value="commission">{{__('admin.Commission')}}</option>
                                                                <option {{ $setting->commission_type  == 'subscription' ? 'selected' : '' }} value="subscription">{{__('admin.Subscription')}}</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-logo-favicon') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->logo) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->logo_two) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->logo_three) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->footer_logo) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->footer_logo_two) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Home Two New Logo')}}</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->footer_logo_three) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.New Logo')}}</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <img src="{{ custom_asset($setting->favicon) }}" alt="" width="50px">
                                                                </div>
                                                            </div>
