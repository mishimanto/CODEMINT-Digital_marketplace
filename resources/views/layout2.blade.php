    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ custom_asset($setting->logo_two) }}" alt="Alasmart" class="img-fluid w-100">
            </a>
...
@yield('frontend-content')
    ...
    <!--=============================
        SUBSCRIBE START
    ==============================-->
    <section class="wsus__subscribe pt_85 pb_90" style="background: url({{ custom_asset($setting->home2_subscription_bg) }});">
        <div class="container">
            <div class="row">
