...
@section('frontend-content')
    <!--=============================
        BREADCRUMB START
    ==============================-->
    <section class="wsus__breadcrumb" style="background: url({{ custom_asset('frontend/images/breadcrumb_bg.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-12">
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="modal" data-bs-target="#stripeModal">
                                    <img src="{{ custom_asset($stripe->image) }}" alt="stripe" class="img-fluis w-100">
                                </button>
                            </li>
                            @endif
                            @if ($paypal->status == 1)
                            <li class="nav-item">
                                ...
                                <button class="nav-link" id="paypal" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($paypal->image) }}" alt="paypal" class="img-fluis w-100">
                                </button>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="mollie" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($mollie->mollie_image) }}" alt="paypal" class="img-fluis w-100">
                                </button>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="instamojo" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($instamojo->image) }}" alt="Degmark" class="img-fluis w-100">
                                </button>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" onclick="payWithPaystack()" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($paystack->paystack_image) }}" alt="Degmark" class="img-fluis w-100">
                                </button>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="rajorpay" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($razorpay->image) }}" alt="Degmark" class="img-fluis w-100">
                                </button>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" onclick="flutterwavePayment()" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($flutterwave->logo) }}" alt="Degmark" class="img-fluis w-100">
                                </button>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="modal" data-bs-target="#bankPayment">
                                    <img src="{{ custom_asset($bankPayment->image) }}" alt="Degmark" class="img-fluis w-100">
                                </button>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                ...
                                <button class="nav-link" id="sslBtn" data-bs-toggle="pill">
                                    <img src="{{ custom_asset($sslcommerz->image) }}" alt="Degmark" class="img-fluis w-100">
                                </button>
                            </li>
                            @endif
                            ...
                            @if (checkModule('PaymentGateway'))
                                @include('checkout_for_addon_payment')
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="wsus__checkout_sidebar" id="sticky_sidebar">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{ custom_asset($cart->options->image) }}" alt="checkout" class="img-fluid w-100">
                                </div>
                                <div class="text">
...
<div class="modal fade" id="bankPayment" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content border-0 shadow rounded-3">
            ...
            <div class="modal-header bg-light border-0">
                <h5 class="modal-title fw-bold text-dark" id="bankPaymentLabel">
            ...
            <form method="POST" action="{{ route('bank-payment') }}">
                ...
                <div class="modal-body p-4">
                    ...
                    <!-- Bank Info -->
                    <div class="mb-4">
                        <h6 class="fw-semibold text-primary mb-2">Required Info</h6>
                    ...
                    <!-- Transaction Info -->
                    <div class="mb-4">
                        <!-- <label for="tnx_info" class="form-label fw-semibold">
                            Transaction Information
                        </label> -->
                        <textarea id="tnx_info" name="tnx_info" class="form-control rounded-3"
                                  rows="3" required
                                  placeholder="{{ __('user.Type your transaction information') }}"></textarea>
                    </div>

                    <!-- Amount (Visible + Hidden) -->
                    <div class="mb-3">
                        <label class="form-label fw-semibold">{{ __('user.Amount') }}</label>
                        <!-- Visible only -->
                        <input type="text" class="form-control fw-bold text-success" 
                               value="$ {{ $cartTotal }}" readonly>
                        <!-- Hidden numeric value (DB save) -->
                        <input type="hidden" name="total_amount" value="{{ $cartTotal }}">
                    </div>
