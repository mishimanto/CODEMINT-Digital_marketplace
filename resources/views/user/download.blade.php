                            ...
                            @if ($item->order->order_status == 1)
                                <div class="wsus__download_item">
                                    <div class="wsus__download_item_left">
                                        <div class="img">
                                            <img src="{{ custom_asset($item->product->thumbnail_image) }}" alt="download" class="img-fluid w-100">
                                        </div>
                                        <div class="text">
                                    ...
                                    <div class="wsus__download_item_right">
                                        ...
                                        <a class="common_btn" href="{{ route('download-script', $item->product->id) }}" target="_blank" >{{__('user.Download File')}}</a>
                                        @else
                                            @if ($item->variant)
                                                <a class="common_btn" href="{{ route('download-variant-item', $item->variant->id) }}" target="_blank">{{__('user.Download File')}}</a>
                                            @endif
                                        @endif
                                        @php
