                            ...
                            <tbody>
                                @foreach ($withdraws as $index=>$withdraw)
                                    <tr>
                                        ...
                                        <td class="method text-center">{{ $withdraw->method }}</td>
                                        <td class="method text-center">
                                            @if (session()->get('currency_position') == 'right')
                                        ...
                                        @if ($withdraw->status==1)
                                            <td class="status text-center"><span class="success">{{__('user.Success')}}</span></td>
                                        @else
                                            <td class="status text-center"><span class="pending">{{__('user.Pending')}}</span></td>
                                        @endif
                                        <td class="report d-flex justify-content-center align-items-center">
                                            @if($withdraw->report_path)
                                                <a href="{{ route('user.withdraw.report.download', $withdraw->id) }}" class="btn btn-sm btn-primary">
                                                    Download
                                                </a>
                                            @else
