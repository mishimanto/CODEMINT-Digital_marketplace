...
@section('frontend-content')
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="wsus__about_us_text">
                        ...
                        <div class="wsus__about_text_img d-flex flex-wrap align-items-center">
                            <div class="img">
                                <img src="{{ custom_asset($about_us->image) }}" alt="about" class="img-fluid w-100">
                            </div>
                            <div class="text">
                            ...
                            <div class="signature">
                                <img src="{{ custom_asset($about_us->signature) }}" alt="about" class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="wsus__about_us_img">
                        <img src="{{ custom_asset($about_us->banner_image) }}" alt="about us" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="wsus__team pt_115 xs_pt_75 mb_120">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__single_team">
                        <img src="{{ custom_asset($our_team->image) }}" alt="team" class="img-fluid w-100">
            ...
            <div class="wsus__purchase" style="background: url({{ custom_asset($our_teem_section->offer_background) }});">
            ...
            <div class="row justify-content-between">
                <div class="col-lg-4 col-md-6">
                    <div class="wsus__why_choose_item">
                        <div class="img">
                            <img src="{{ custom_asset($why_choose_us->item_icon1) }}" alt="why choose" class="img-fluid w-100">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wsus__why_choose_item center">
                        <div class="img">
                            <img src="{{ custom_asset($why_choose_us->item_icon2) }}" alt="why choose" class="img-fluid w-100">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wsus__why_choose_item last">
                        <div class="img">
                            <img src="{{ custom_asset($why_choose_us->item_icon3) }}" alt="why choose" class="img-fluid w-100">
                        </div>
