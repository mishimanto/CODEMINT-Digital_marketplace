...
@section('frontend-content')
    ...
    <!--=============================
        BANNER 2 START
    ==============================-->
    <section class="wsus__banner_2" style="background: url({{ custom_asset($intro_section->content->home1_bg) }});">
        <div class="container">
            <div class="row">
                <div class="col-xl-10 col-md-10 m-auto">
                    <div class="wsus__banner_text_2 wow fadeInUp" data-wow-duration="1s">
                        ...
                        <ul class="wsus__banner_counter_2 d-flex flex-wrap justify-content-center mt_40">
                            <li>
                                <span class="counter">{{ $counter_section->counter1_value }}</span>
                                <!-- <span>{{ __('user.k') }}+</span> -->
                                <!-- {{ $counter_section->counter1_title }} --> Items
                            </li>
                            <li>
                                <span class="counter">{{ $counter_section->counter2_value }}</span>
                                <!-- <span>{{ __('user.k') }}+</span> -->
                                <!-- {{ $counter_section->counter2_title }} -->Items Sales
                            </li>
                            <li>
                                <span class="counter">{{ $counter_section->counter3_value }}</span>
                                <!-- <span>{{ __('user.k') }}+</span> -->
                                <!-- {{ $counter_section->counter3_title }} --> Clients
                            </li>
                        </ul>
                    </div>
                </div>
                                                    ...
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="wsus__trending_theme_item">
                                                            <div class="wsus__trending_theme_item_img">
                                                                <img src="{{ custom_asset($trending_product->thumbnail_image) }}" alt="img"
                ...
                <!-- <div class="col-xl-4 col-lg-5">
                    <div class="wsus__trending_theme_single">
                        <div class="wsus__trending_theme_single_img">
                            <img src="{{ custom_asset($trending_section->trending_offer_image) }}" alt="trendy theme" class="img-fluid w-100">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="wsus__single_counter">
                        <div class="icon">
                            <img src="{{ asset($counter_section->home1_icon1) }}" alt="counter">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="wsus__single_counter">
                        <div class="icon">
                            <img src="{{ asset($counter_section->home1_icon2) }}" alt="counter">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="wsus__single_counter">
                        <div class="icon">
                            <img src="{{ asset($counter_section->home1_icon3) }}" alt="counter">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="wsus__single_counter">
                        <div class="icon">
                            <img src="{{ asset($counter_section->home1_icon4) }}" alt="counter">
                        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-xl-5 col-md-5">
                    <div class="wsus__download_2_img">
                        <img src="{{ custom_asset($mobile_app->home1_foreground) }}" alt="download" class="img-fluid w-100">
                    </div>
                </div>
                ...
                <div class="col-xxl-2 col-sm-6 col-lg-3">
                    <div class="wsus__customer_logo">
                        <a href="{{ $partner->link }}" target="__blank">
                            <img src="{{ custom_asset($partner->logo) }}" alt="brand" class="img-fluid w-100">
                        </a>
                    </div>
                </div>
                @endforeach
                    ...
                    <div class="wsus__blog_3">
                        ...
                        <div class="wsus__blog_3_text">
                            ...
                            <ul>
                                <li>
                                    <div class="img">
                                        <img src="{{ custom_asset($blog->admin->image) }}" alt="author" class="img-fluid w-100">
                                    </div>
