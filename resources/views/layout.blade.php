...
<body class="home_2">
    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ custom_asset($setting->logo) }}" alt="Alasmart" class="img-fluid w-100">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:;"><!-- {{__('user.Pages')}} --> More<i class="far fa-chevron-down"></i></a>
                        <ul class="wsus__droap_menu">
    ...
    @php
        ...
        $total_user = App\Models\User::where('is_provider', 0)->get()->count();
    ...
    <footer class="mt_145" style="background: url({{ asset('frontend/images/footer_bg.jpg') }});">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="wsus__subscribe_2 mb_80" style="background: url({{ custom_asset($setting->subscription_bg) }});">
